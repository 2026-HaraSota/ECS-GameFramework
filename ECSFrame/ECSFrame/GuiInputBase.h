...
public:
	...
	*/
		...
		: GuiItemBase(label, id, true), m_on_value_changed(nullptr)
	{
		...
		{
		case OverWriteMode::RETURN: m_over_write_flag = ImGuiInputTextFlags_EnterReturnsTrue; break;
		case OverWriteMode::ALWAYS: m_over_write_flag = ImGuiInputTextFlags_AlwaysOverwrite; break;
		default: m_over_write_flag = ImGuiInputTextFlags_AlwaysOverwrite; break;
		}
	}
