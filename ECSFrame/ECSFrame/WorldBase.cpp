...
void WorldBase::RegisterWorldSystems()
{
	...
	// 物理
	m_system_manager->AddSystem<MovementSystem>(SystemManager::UpdateProcessType::PHYSICS, false,
	...
	m_system_manager->AddSystem<Circle2DCollisionSystem>(SystemManager::UpdateProcessType::PHYSICS, false,
...
void WorldBase::LoadWorldResources()
{
	...
	m_num_resource_loading = need_texture_names.size() + need_model_names.size() + 
		need_sound_names[SoundManager::SoundType::SE].size() + need_sound_names[SoundManager::SoundType::BGM].size();
