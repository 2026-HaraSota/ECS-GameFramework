...
/**
* @breif 識別ビットとコンポーネントが要求するアライメントのマップ
*/
inline std::unordered_map<ComponentBits, size_t> bitToAlign;
...
/**
* @brief コンポーネントのアライメントを登録
* @param[in] bit 識別ビット
* @param[in] align アライメント
*/
void RegisterAlign(ComponentBits bit, size_t align);

/**
* @brief コンポーネントのアライメントを取得
* @param[in] bit 識別ビット
*/
size_t GetAlign(ComponentBits bit);
