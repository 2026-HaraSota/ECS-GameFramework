...
void WorldManager::Update(float deltaTime)
{
	...
	case FadeOut:
		...
		// 入れ替えモードなら
		if (m_world_activate_handle.GetActivateMode() == WorldActivateHandle::ActivateMode::CHANGE)
		{
			// 一番上のワールドを削除
...
void WorldManager::ActivateBeginningWorld()
{
	...
	// 起動
	ActivateWorld(world_name, WorldActivateHandle::ActivateMode::CHANGE, false);
}
